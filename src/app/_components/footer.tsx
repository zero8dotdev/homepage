...
const Footer = () => {
  return (
    <footer className="col-span-full text-description grid grid-rows-[auto_20px_auto] grid-cols-3 md:grid-cols-6 w-full text-base gap-x-4 mt-20 gap-y-8">
      ...
      <div className="row-start-2 col-span-1 text-center md:text-left  text-description">
        (c) Zero8 2024
      </div>
