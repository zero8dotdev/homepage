...
const SlideButton: React.FC<SlideButtonProps> = ({ title }) => {
  return (
    <button className="border-none relative overflow-hidden group flex items-center gap-3 px-6 py-4 border-2 text-lg lg:text-2xl font-medium text-onyx transition-all duration-300 bg-primary">
